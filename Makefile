...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Sun Jan 10 12:30:22 2010
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/dclient21.0.0/ && $(COPY_FILE) --parents armor.h chardescwidget.h charprofile.h charstats.h diceroller.h feats.h gear.h interface.h spells.h tabs.h weapon.h .tmp/dclient21.0.0/ && $(COPY_FILE) --parents armor.cpp chardescwidget.cpp charprofile.cpp charstats.cpp diceroller.cpp feats.cpp gear.cpp gear_item.cpp interface.cpp main.cpp spells.cpp tabs.cpp weapon.cpp .tmp/dclient21.0.0/ && (cd `dirname .tmp/dclient21.0.0` && $(TAR) dclient21.0.0.tar dclient21.0.0 && $(COMPRESS) dclient21.0.0.tar) && $(MOVE) `dirname .tmp/dclient21.0.0`/dclient21.0.0.tar.gz . && $(DEL_FILE) -r .tmp/dclient21.0.0
...
compiler_moc_header_make_all: moc_armor.cpp moc_chardescwidget.cpp moc_charprofile.cpp moc_charstats.cpp moc_diceroller.cpp moc_feats.cpp moc_gear.cpp moc_interface.cpp moc_spells.cpp moc_tabs.cpp moc_weapon.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_armor.cpp moc_chardescwidget.cpp moc_charprofile.cpp moc_charstats.cpp moc_diceroller.cpp moc_feats.cpp moc_gear.cpp moc_interface.cpp moc_spells.cpp moc_tabs.cpp moc_weapon.cpp
