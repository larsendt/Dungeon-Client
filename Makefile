#############################################################################
# Makefile for building: Dungeon-Client
# Generated by qmake (2.01a) (Qt 4.5.2) on: Tue Mar 30 16:58:09 2010
# Project:  Dungeon-Client.pro
# Template: app
# Command: /usr/bin/qmake -unix -o Makefile Dungeon-Client.pro
#############################################################################
...
DIST          = /usr/share/qt4/mkspecs/common/g++.conf \
		...
		Dungeon-Client.pro
QMAKE_TARGET  = Dungeon-Client
DESTDIR       = 
TARGET        = Dungeon-Client
...
Makefile: Dungeon-Client.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/features/qt_functions.prf \
	...
	$(QMAKE) -unix -o Makefile Dungeon-Client.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Dungeon-Client1.0.0 || $(MKDIR) .tmp/Dungeon-Client1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Dungeon-Client1.0.0/ && $(COPY_FILE) --parents armor.h chardescwidget.h charstats.h diceroller.h feats.h gear.h interface.h skills.h spells.h tabs.h weapon.h .tmp/Dungeon-Client1.0.0/ && $(COPY_FILE) --parents armor.cpp chardescwidget.cpp charstats.cpp diceroller.cpp feats.cpp gear.cpp interface.cpp main.cpp skills.cpp spells.cpp tabs.cpp weapon.cpp .tmp/Dungeon-Client1.0.0/ && (cd `dirname .tmp/Dungeon-Client1.0.0` && $(TAR) Dungeon-Client1.0.0.tar Dungeon-Client1.0.0 && $(COMPRESS) Dungeon-Client1.0.0.tar) && $(MOVE) `dirname .tmp/Dungeon-Client1.0.0`/Dungeon-Client1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Dungeon-Client1.0.0
...
compiler_moc_header_make_all: moc_armor.cpp moc_chardescwidget.cpp moc_charstats.cpp moc_diceroller.cpp moc_feats.cpp moc_gear.cpp moc_interface.cpp moc_skills.cpp moc_spells.cpp moc_tabs.cpp moc_weapon.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_armor.cpp moc_chardescwidget.cpp moc_charstats.cpp moc_diceroller.cpp moc_feats.cpp moc_gear.cpp moc_interface.cpp moc_skills.cpp moc_spells.cpp moc_tabs.cpp moc_weapon.cpp
