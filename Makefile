...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Mon Feb 8 12:04:04 2010
# Project:  client.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/client1.0.0/ && $(COPY_FILE) --parents armor.h chardescwidget.h charstats.h diceroller.h feats.h gear.h interface.h skills.h spells.h tabs.h weapon.h .tmp/client1.0.0/ && $(COPY_FILE) --parents armor.cpp chardescwidget.cpp charstats.cpp diceroller.cpp feats.cpp gear.cpp interface.cpp main.cpp skills.cpp spells.cpp tabs.cpp weapon.cpp .tmp/client1.0.0/ && (cd `dirname .tmp/client1.0.0` && $(TAR) client1.0.0.tar client1.0.0 && $(COMPRESS) client1.0.0.tar) && $(MOVE) `dirname .tmp/client1.0.0`/client1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/client1.0.0
